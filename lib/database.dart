...
final List<Treasure> huntTreasures = [
  ...
  Treasure(
      ...
      longitude: 3.3619,
      clue:
          "Find the words of wisdom from the influential advocate for women's rights and social justice in Nigeria.", rarity: "Very Rare"),
  Treasure(
      id: '5',
      name: "Egungun Mask",
      ...
      latitude: 7.3775,
      longitude: 3.9470,
      clue: "Search for the mask that brings ancestral spirits to life.", rarity: "Common"),
  Treasure(
      id: '6',
      ...
      modelUrl: "assets/bronze_cast_of_a_head_edo_nigeria.glb",
      historicalSignificance:
          "Represents the rich artistry of the Benin Kingdom.",
      latitude: 6.3350,
      longitude: 5.6037,
      clue: "Look for the intricate bronze artwork of the Benin Kingdom.", rarity: "Rare"),
  Treasure(
      id: '7',
      name: "Ken Saro-Wiwa",
      ...
      latitude: 4.5361,
      longitude: 7.0733,
      clue: "Find the statue of the renowned Ogoni freedom fighter", rarity: "Rare"),
  Treasure(
      id: '8',
      ...
      latitude: 4.7750,
      longitude: 6.9986,
      clue: "Discover the events that shaped the Niger Delta crisis.", rarity: "Common"),
  Treasure(
      id: '9',
      ...
      latitude: 4.5361,
      longitude: 7.0733,
      clue: "Find the words of Ken Saro Wiwa before he was executed", rarity: "Rare"),
  Treasure(
      id: '10',
      name: "Karikpo Mask",
      ...
      modelUrl: "assets/karikpo_mask_antelope.glb",
      historicalSignificance:
      ...
      latitude: 4.8288,
      longitude: 6.9786,
      clue: "Search for mask of Kana erratic dancers", rarity: "Super Rare"),
  Treasure(
      id: '11',
      ...
      longitude: 7.4916,
      clue:
          "Discover the ancient bronze artifacts that tell the story of Igbo heritage.", rarity: "Super Rare"),
  Treasure(
      id: '12',
      name: "Nnamdi Azikiwe",
      description:
      ...
      latitude: 6.4500,
      longitude: 7.5000,
      clue: "Find the first President of Nigeria.", rarity: "Common"),
  Treasure(
      id: '13',
      ...
      longitude: 7.3667,
      // Adjust coordinates if needed
      clue: "Explore the site related to the historic conflict in Nigeria.", rarity: "Common"),
  Treasure(
      id: '14',
      ...
      latitude: 6.4500,
      longitude: 7.5000,
      clue: "Find the words of wisdom from Nigeria's first President.", rarity: "Common"),
  Treasure(
      id: '15',
      name: "Igbo Hand Fan",
      ...
      modelUrl: "assets/igbo_odogwu_hand_fan_3d_model.glb",
      historicalSignificance:
      ...
      // Adjust coordinates if needed
      clue:
          "Find the traditional artifact used in Igbo ceremonies and festivals.", rarity: "Common"),
  Treasure(
      id: '16',
      ...
      modelUrl: "assets/tiv_ceremonial_staff.glb",
      historicalSignificance:
      ...
      longitude: 7.4951,
      // Adjust coordinates if needed
      clue: "Find the traditional staff used in Tiv ceremonies and rituals.", rarity: "Very Rare"),
  Treasure(
      id: '17',
      ...
      // Adjust coordinates if needed
      clue:
          "Discover the beautifully crafted brass artifacts of the Nupe people.", rarity: "Rare"),
  Treasure(
      id: '17',
      ...
      latitude: 10.2152,
      longitude: 7.9585,
      clue: "Find the statue of the revered leader of Northern Nigeria.", rarity: "Common"),
  Treasure(
      id: '18',
      ...
      // Adjust coordinates if needed
      clue:
          "Explore the site of the tragic violence that shook te North in 2001.", rarity: "Rare"),
  Treasure(
      id: '19',
      ...
      latitude: 10.2152,
      longitude: 7.9585,
      clue: "Find the wise words of the Sardauna of Sokoto.", rarity: "Common"),
  Treasure(
      id: '21',
      ...
      latitude: 12.0022,
      longitude: 8.5919,
      clue: "Look for the grand celebrations of the Durbar Festival.", rarity: "Rare"),
  Treasure(
      id: '22',
      name: "Amina of Zaria",
      description:
      ...
      longitude: 3.8774,
      clue:
          "Find the legacy of the powerful queen who expanded the Zaria kingdom.", rarity: "Very Rare"),
  Treasure(
      id: '23',
      ...
      longitude: 3.8774,
      clue:
          "Uncover the impact of Usman dan Fodio's jihad on the Hausa and Fulani states.", rarity: "Rare"),
  Treasure(
      id: '24',
      ...
      modelUrl: "assets/sword_of_the_old.glb",
      historicalSignificance:
      ...
      longitude: 5.2476,
      clue:
          "Uncover the symbol of authority and tradition from the Hausa Emirate.", rarity: "Super Rare"),
  Treasure(
      id: '25',
      ...
      modelUrl: "assets/pre-islamic_silver_coin_saa003n.glb",
      historicalSignificance:
          "Represents the economic history of the Sokoto Caliphate.",
      latitude: 13.0059,
      longitude: 5.2476,
      clue:
          "Search for the coins that circulated during the Sokoto Caliphate era.", rarity: "Very Rare"),
];
